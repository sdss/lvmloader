...
try:
    from lvmloader import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-lvmloader') or 'dev'
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.autosummary',
              ...
              'sphinx.ext.intersphinx', 'sphinx_copybutton', 'sphinx_inline_tabs']
...
project = 'lvmloader'
copyright = '{0}, {1}'.format('2023', 'Brian Cherinka')
...
.. |lvmloader_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('lvmloader')
...
man_pages = [
    (master_doc, 'lvmloader', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/lvmloader'
